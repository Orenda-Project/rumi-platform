-- Migration 020: Add invitations table and update access_scopes
...
-- =============================================================================
-- -- Verify access_scopes has updated_at column
-- SELECT column_name, data_type FROM information_schema.columns
-- WHERE table_name = 'access_scopes' AND column_name = 'updated_at';
--
-- -- Verify invitations table exists
-- SELECT table_name FROM information_schema.tables WHERE table_name = 'invitations';
--
-- -- Verify invitations indexes
