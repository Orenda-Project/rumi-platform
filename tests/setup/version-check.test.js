...
describe('checkForUpdates', () => {
  ...
  it('returns { upToDate: true } when current version matches latest release', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ...
      json: async () => ({
        tag_name: 'v2.9.39',
        html_url: 'https://github.com/Orenda-Project/rumi-platform/releases/tag/v2.9.39',
      }),
    });
  ...
  it('returns update info when a newer version exists', async () => {
    global.fetch = jest.fn().mockResolvedValue({
      ...
      json: async () => ({
        tag_name: 'v3.0.0',
        html_url: 'https://github.com/Orenda-Project/rumi-platform/releases/tag/v3.0.0',
      }),
    });
    ...
    expect(result).toEqual({
      ...
      current: '2.9.39',
      latest: '3.0.0',
      url: 'https://github.com/Orenda-Project/rumi-platform/releases/tag/v3.0.0',
    });
  });
